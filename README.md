...
Estático puro — a raiz do repo é servida como um projeto único (GitHub Pages ou Vercel, sem build command). Cada subpasta vira um caminho: `/mimica`, `/ito`, `/batata-quente`.
